...
?>
    ...
    if(isset($_POST['postComment' . $post_id]))
    {
        ...
        //inserting post comments into database
        ...
        //below portion
        //we are sending post id so that it get to know to which post it should add the comments

    ?>

    <form action="comment_frame.php?post_id=<?php echo $post_id;?>" id="comment_form" name="postComment<?php echo $post_id;?>" method="POST" style="z-index:2;">
